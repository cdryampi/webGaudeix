    ...
    fieldsets = [
        (None, {
            ...
            'description': (
                ...
                "<p><strong>Nota:</strong> Pots esborrar totes les plantilles des del llistat de newsletter, així no omplim el servidor de fitxers innecessaris des de Personalització.</p>"
            ),
        }),
    ]
